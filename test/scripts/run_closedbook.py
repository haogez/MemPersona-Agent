...
def main(argv: List[str] | None = None) -> None:
    parser = argparse.ArgumentParser(description="Closed-book eval on TIME-Lite")
    ...
    pred_path = OUTPUT_DIR / "predictions" / "closedbook.jsonl"
    done = {}
    ...
    all_recs = []
    total = len(data)
    pbar = tqdm(total=len(data), desc="closedbook")
